...
func (_m *Requester) CallForecastData(_a0 context.Context, payload *model.GetForecastRequest) ([]*model.GetForecastData, error) {
...
func (_m *Requester) CallResamplingData(_a0 context.Context, payload *model.GetAllSensorResponse) ([]*model.GetSampledData, error) {
	ret := _m.Called(_a0, payload)
